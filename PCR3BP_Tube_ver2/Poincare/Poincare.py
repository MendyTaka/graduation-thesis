...
def Poincare(energy, N=100, eps=1e-6):
    ...
    tube_L1_name = ['U1_stable', 'U1_unstable', 'U3_stable', 'U2_unstable']
    ...
    tube_L2_name = ['U4_stable', 'U4_unstable', 'U2_stable', 'U3_unstable']
...
def main():
    ...
    ax1.scatter(poincare['U1_stable'][0], poincare['U1_stable'][2],c='b',s=5,label='stable')
    ax1.scatter(poincare['U1_unstable'][0], poincare['U1_unstable'][2],c='r',s=5, label='unstable')
    #図の設定
    ax1.set_xlabel('$\it{x}$',fontsize=25,fontstyle='italic')
    ax1.set_ylabel('$v_x$',fontsize=25)
    ax1.set_xlim(-1,0)
    ...
    ax2.scatter(poincare['U2_stable'][1], poincare['U2_stable'][3],c='b',s=5,label='stable')
    ax2.scatter(poincare['U2_unstable'][1], poincare['U2_unstable'][3],c='r',s=5, label='unstable')
    #図の設定
    ...
    ax3.scatter(poincare['U3_stable'][1], poincare['U3_stable'][3],c='b',s=5,label='stable')
    ax3.scatter(poincare['U3_unstable'][1], poincare['U3_unstable'][3],c='r',s=5, label='unstable')
    #図の設定
    ...
    ax4.scatter(poincare['U4_stable'][0], poincare['U4_stable'][2],c='b',s=5,label='stable')
    ax4.scatter(poincare['U4_unstable'][0], poincare['U4_unstable'][2],c='r',s=5, label='unstable')
    #図の設定
    ax4.set_xlabel('$\it{x}$',fontsize=25,fontstyle='italic')
    ax4.set_ylabel('$v_x$',fontsize=25)
    ax4.set_xlim(-4,-2)
